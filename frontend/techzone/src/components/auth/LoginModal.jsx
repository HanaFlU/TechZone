      ...
      <div className="fixed inset-0 bg-opacity-500 flex items-center justify-center z-50">
        <div className="bg-white p-6 rounded w-full max-w-sm relative">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="bg-green-600 text-white w-full py-2 rounded">Đăng nhập</button>
          </form>
          <p className="mt-4 text-sm text-center">
            Chưa có tài khoản?{' '}
            <button className="text-green-600" onClick={onSwitch}>Đăng ký</button>
          </p>
        </div>
      </div>
    );
